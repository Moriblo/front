...
### API Obras de Arte [app.py] :: API C - https://github.com/Moriblo/app
### API Tradutor [tradutor.py] :: API B1 - https://github.com/Moriblo/tradutor
### API Search in Museum [smuseum.py] :: API B2 - https://github.com/Moriblo/smuseum
